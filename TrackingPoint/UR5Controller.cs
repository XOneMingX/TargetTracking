...
public class UR5Controller : MonoBehaviour
{
    ...
    void initializeCube()
    {
        ...
        controlCube.transform.position = new Vector3(0, 0.5f, -0.5f);
        controlCube.transform.localScale = new Vector3(5f, 5f, 5f);
    ...
    void TrackingPoint()
    {
        ...
        if (userHasHitOk)
        {
            ...
            floatX = controlCube.transform.position.x;
            floatY = controlCube.transform.position.y;
            floatZ = controlCube.transform.position.z;
            floatPhi = controlCube.transform.eulerAngles.x;
            floatTheta = controlCube.transform.eulerAngles.y;
    ...
    void LimitBlock()
    {
        ...
        if(distance > radius)
        {
            Vector3 fromOriginToObject = controlCube.transform.position - RobotBase.transform.position;
            fromOriginToObject *= radius / distance;
            Vector3 newLoc = RobotBase.transform.position + fromOriginToObject;
            controlCube.transform.position = newLoc;
        }
        /*
